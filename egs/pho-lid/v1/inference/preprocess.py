...
#     cutset = RecordWithSupervision(audio_dir, save_dir, audio_pattern, rttm_file, vad_file).vad_cuts
#     # cutset.describe()
...
#     my_model.load("../models/pholid_seame_bf_pho/pholid_seame_bf_pho_epoch_4.ckpt")
