...
# processed_data_dir="/export/fs05/ywang793/hyperion/egs/pho-lid/v1/data/seame"
...
# sort ./data/seame/merge/pure/feat2lang_train.txt | uniq -u
# sort ./data/seame/merge/pure/feat2lang_test.txt | uniq -u
# sort ./data/seame/merge/cat/feat2lang_train.txt | uniq -u
# sort ./data/seame/merge/cat/feat2lang_test.txt | uniq -u
