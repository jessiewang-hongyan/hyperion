...
def main():
    ...
    # embeddings_new = pca.fit_transform(embeddings_new)
    # embeddings_no_norm_new = pca.fit_transform(embeddings_no_norm_new)
    ...
    reducer = umap.UMAP()
    emb_plot = reducer.fit_transform(embeddings_new)
    emb_plot_no_norm = reducer.fit_transform(embeddings_no_norm_new)
    print(f"emb_plot shape: {emb_plot.shape}, emb_plot no norm shape: {emb_plot_no_norm.shape}")
    ...
    emb_dim1 = emb_plot[:, 0]
    emb_dim2 = emb_plot[:, 1]
    emb_no_norm_dim1 = emb_plot_no_norm[:, 0]
    emb_no_norm_dim2 = emb_plot_no_norm[:, 1]
    ...
    plt.savefig("./emb_with_norm_seame_umap.png")
    ...
    plt.savefig("./emb_without_norm_seame_umap.png")
